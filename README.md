...
-  **[URL Shortner with Spring Boot]([https://github.com/openclaw/openclaw](https://github.com/arnavbansal2764/url-shortner-springboot))** - A simple backend project which shortens a url
